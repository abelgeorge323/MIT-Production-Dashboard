...
def load_active_roster():
    ...
    try:
        ...
        # Process the top section (Training info)
        # Filter out rows where MIT Count is NaN or empty (these are the bottom section)
        ...
        # Process the bottom section (MIT Entering the Program)
        # Find rows where MIT Count is NaN - these are the new candidates
